...
function HeroSection(){
    return(
      <section className="h-screen flex flex-col justify-center item-center">
        <div className="text-center space-y-7">
          <p className="font-bold lg:text-red-950 text-red-400 text-[14px]">
            ...
            <p className="px">Try us free|No credit card required|Cancel anytime</p>
        </div>
        <div className="flex space-x-7">
          <div className="border-4 cursor-pointer gap-5 space-y-7 hover:border-[#00a2ff]" >
            <h1 className="font-bold text-[35px] lg:text-[60px] leading-tight text-[#00a2ff]">10% list growth & <h1 className="text-black">sales spike in tough niche</h1></h1>
          ...
          <div className="border-4 cursor-pointer gap-5 space-y-7 hover:border-[#00a2ff] ">
            <h1 className="font-bold text-[30px] lg:text-[60px] leading-tight text-[#00a2ff]">75% of all public <h1 className="text-black">sales from  email autoresponders</h1></h1>
            <p>Together with GetResponse, we`ve been able to convince customers of need,cuminating in compelling sales</p>
            <button className="px-9  py-3 rounded-3xl font-bold w-fit bg-[#00a2ff]  flex items-center gap-1 text-white hover:bg-amber-300 hover:text-black">
            Read case study<FaArrowRightLong  className="mt-1"/>
            </button>
          </div>
          <div className="border-4 cursor-pointergap-5 space-y-7 hover:border-[#00a2ff]">
