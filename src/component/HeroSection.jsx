    ...
    return(
      <section className="h-100 w-90 flex flex-col justify-center item-center space-y-8 px-20">
        ...
        <div className="flex space-x-7">
          <div className="shadow-md  h-100 w-auto rounded-2xl cursor-pointer gap-5 space-y-7 hover:border-[#00a2ff] hover:border-4 px-4" >
            <div>
          ...
          <div className="shadow-md  rounded-2xl cursor-pointer gap-5 space-y-16 hover:border-4 hover:border-[#00a2ff] px-4 ">
            <div>
          ...
          <div className="shadow-md rounded-2xl cursor-pointer gap-5 space-y-7 hover:border-[#00a2ff] hover:border-4 px-4">
            <div>
