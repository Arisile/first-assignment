  ...
  const [isMobile, setIsMobile]=useState(false);
    ...
    return(
      ...
      <ul className="lg:flex hidden gap-9 font-semibold cursor-pointer">
                <li className="hover:text-[#00a2ff] flex items-center gap-1">Product <IoIosArrowForward  className=" mt-1 " /></li>
                <li className="hover:text-[#00a2ff]">Pricing </li>
                <li className="hover:text-[#00a2ff] flex items-center gap-1">Resources <IoIosArrowForward className="mt-1" /></li>
                <li className="hover:text-[#00a2ff]">Book a demo</li>
            </ul>
         </div>
         <div>
        {isMobile?(<TfiClose className="lg-hidden text-3xl flex " />

        ) :(<RxHamburgerMenu onClick={ToggleBar} className="flex lg:hidden text-3xl z-10"/>)}
         ...
         {isLogin ? (
          ...
          <button onClick={Login} className="px-3 py-3 border-2 rounded-2xl font-bold hover:border-2 hover:text-[#00a2ff] hover:border-[#00a2ff]">
            Log in
            </button>
       ...
       {isMobile &&<nav className="absolute right-0 top-0 h-[90%] lg:hidden  w-[90%] p-6 text-xl">
