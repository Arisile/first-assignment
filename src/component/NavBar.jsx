  ...
  const [Mobile, setMobile]=useState(false);
    ...
    return(
      ...
      <ul className="lg:flex hidden gap-9 font-semibold cursor-pointer">
        <Link to="/Product">
        <li onClick={Product} className="hover:text-[#00a2ff] flex items-center gap-1">Product <IoIosArrowForward  className=" mt-1 " /></li>
        </Link>
         ...
         <div>
        {Mobile?(<TfiClose onClick={ToggleBar} className="lg-hidden text-3xl flex " />
